...
//CONTSTRUCTORES
	...
	public Libro(String id, String isbn, String titulo, String autor, String editorial, String precio, String fechaDevolucion, String prestado) throws IsbnException, CamposVaciosException, NumberFormatException, DateTimeParseException {
		super();
		setId(id);
		setIsbn(isbn);
		setTitulo(titulo);
...
//GETTERS Y SETTERS
	...
	public void setId(String id) throws CamposVaciosException {
		if(id.equals("")) {
