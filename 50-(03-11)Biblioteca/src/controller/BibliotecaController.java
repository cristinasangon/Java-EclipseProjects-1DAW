...
public class BibliotecaController {
	...
	public BibliotecaController() throws IOException, NumberFormatException, DateTimeParseException, IsbnException, CamposVaciosException {
		...
		while((linea = br.readLine()) != null) {
			...
			String isbn = lineaSeparada[0];
			String titulo = lineaSeparada[1];
			String autor = lineaSeparada[2];
			String editorial = lineaSeparada[3];
			String fechaDevolucion = lineaSeparada[4];
			String precio = lineaSeparada[5];
			String prestado = lineaSeparada[6];
			
			Libro libro = new Libro(isbn, titulo, autor, editorial, precio, fechaDevolucion, prestado);
