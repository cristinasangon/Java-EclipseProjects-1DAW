...
//C O N S T R U C T O R E S 
	...
	public Libro(int idLibro, String titulo, String autor, String editorial, boolean prestado, LocalDate fechaPestamo,
			LocalDate fechaDevolucion, String isbn, LocalDateTime fechaAlta) throws IsbnException, CamposVaciosException {
		super();
		setIdLibro(idLibro);
		setTitulo(titulo);
		setAutor(autor);
...
//F U N C I O N E S   O   M E T O D O S
...
//T O   S T R I N G
	...
	public String toString() {
		return "Libro [idLibro=" + idLibro + ", titulo=" + titulo + ", autor=" + autor + ", editorial=" + editorial
				+ ", prestado=" + prestado + ", fechaPestamo=" + fechaPestamo + ", fechaDevolucion=" + fechaDevolucion
