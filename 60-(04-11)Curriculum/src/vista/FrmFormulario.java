...
public class FrmFormulario extends JFrame {
	...
	//DATOS
	private String nombre, apellidos, direccion, telefono, poblacion, estadoCivil, lenguajes, sistemas, expProf, frase;
	...
	private void definirEventos() {
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					sistemas = listSistemas.getSelectedValue().toString();
				} catch (Exception e2) {
					// TODO: handle exception
				}
	...
	private void definirVentana() {
		...
		panelSistemasOperativos.setBounds(365, 30, 219, 79);
		panel.add(panelSistemasOperativos);
		panelSistemasOperativos.setLayout(new BorderLayout(0, 0));
		
		scrollPane = new JScrollPane();
		panelSistemasOperativos.add(scrollPane, BorderLayout.CENTER);
		
		modelo = new DefaultListModel();
		
		listSistemas = new JList(modelo);
		listSistemas.setForeground(new Color(0, 107, 215));
		listSistemas.setFont(new Font("Tahoma", Font.BOLD, 12));
		listSistemas.setBackground(new Color(200, 227, 255));
		scrollPane.setViewportView(listSistemas);
		
		modelo.addElement("Windows 7"); modelo.addElement("Windows 10"); modelo.addElement("Windows 11"); modelo.addElement("Linux");
		...
		panelExperienciaProfesional.setBounds(365, 119, 219, 216);
		...
		textAreaExpProfesional.setBounds(10, 20, 199, 186);
