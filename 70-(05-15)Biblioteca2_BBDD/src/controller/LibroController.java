...
public class LibroController {
	...
	public List<Libro> getLibros(String slq) throws SQLException, CamposVaciosException, IsbnException{
		LibroDao libroDao = new LibroDao();
		return libroDao.consultaLibros(slq);
	}
	...
	public boolean agregarLibro(String titulo, String autor, String editorial, String isbn) throws SQLException, CamposVaciosException, IsbnException {
		...
		return libroDao.agragarLibro(titulo, autor, editorial, isbn);
	}
